...
macro(SlicerMacroTranslation)
  ...
  set(expected_nonempty_vars SRCS TS_DIR TS_BASEFILENAME TS_LANGUAGES)
  ...
  list(GET QM_OUTPUT_FILES 1 QM_OUTPUT_FIRST_FILE)
  ...
  # Install language
  # ---------------------------------------------------------------------------------
  message("Slicer_INSTALL_QM_DIR : ${Slicer_INSTALL_QM_DIR}")
  install(
